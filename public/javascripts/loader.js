...
define('fuelux/wizard',['require','jquery'],function (require) {
	...
	var Wizard = function (element, options) {
		...
		this.$prevBtn = this.$element.parent().find('input.btn-prev');
		this.$nextBtn = this.$element.parent().find('input.btn-next');

		//kids = this.$nextBtn.children().detach();
		this.nextText = $.trim(this.$nextBtn.val());
